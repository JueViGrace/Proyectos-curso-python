...
--------------- Alumno {index + 1} ---------------
    ...
    Promedio: {estudiante['promedio']}
                ...
                while (
                    not grade_1_input.replace(".", "").isdigit()
                    or grade_1 < 0.0
                    or not grade_1_input
                ):
                ...
                while (
                    not grade_2_input.replace(".", "").isdigit()
                    or grade_2 < 0.0
                    or not grade_2_input
                ):
                ...
                while (
                    not grade_3_input.replace(".", "").isdigit()
                    or grade_3 < 0.0
                    or not grade_3_input
                ):
                ...
                while (
                    not id_estudiante.isdigit()
                    or int(id_estudiante) < 0
                    or not id_estudiante
                ):
                    print("La cédula debe ser un número entero y mayor a 0")
                    id_estudiante = input(
                        "Ingrese la cédula del estudiante a actualizar: "
                    )
                ...
                for index, estudiante in enumerate(estudiantes.copy()):
                    if int(id_estudiante) == estudiante["cedula"]:
                        ...
                        while (
                            lastname_input.replace(",", ".").isdigit()
                            or not lastname_input
                        ):
                            print("El apellido debe ser un apellido válido")
                            name_input = input("Ingrese el apellido del estudiante: ")
                        ...
                        while (
                            not id_input.isdigit() or int(id_input) < 0 or not id_input
                        ):
                            print("La cédula debe ser un número entero y mayor a 0")
                            id_input = input("Ingrese la cédula del estudiante: ")
                        ...
                        print(
                            "------- La cédula ingresada no se encuentra en la lista de estudiantes -------"
                        )
                        print()
        ...
        print(
            "------- Debe escribir el número asignado a alguna de las opciones -------"
        )
        print()
print("Terminado")
